...
################################################################
# This is a generated script based on design: ps_emio_eth_sgmii
#
...
# source ps_emio_eth_sgmii_script.tcl
...
if { ${design_name} eq "" } {
  ...
  set_property USER_COMMENTS.comment_0 "PS-EMIO SGMII ETHERNET" [get_bd_designs $design_name]
...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net xlconstant_0_dout1 [get_bd_ports pl_reset_led] [get_bd_pins gig_ethernet_pcs_pma_0/reset] [get_bd_pins xlslice_5/Dout]
  ...
  connect_bd_net -net zynq_ultra_ps_e_0_emio_gpio_o [get_bd_pins xlslice_5/Din] [get_bd_pins zynq_ultra_ps_e_0/emio_gpio_o]
